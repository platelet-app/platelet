...
export class HostingConstruct extends Construct {
    constructor(scope: Construct, id: string, props: HostingConstructProps) {
        ...
        */
        ...
        new CfnOutput(this, 'PlatformCertificate', {value: certificate.certificateArn});
        ...
        new CfnOutput(this, 'LandingPageBucket', {value: siteBucket.bucketName});

        // 4. Deploy CloudFront distribution
        const distribution = new cloudfront.Distribution(this, 'PlatformDistribution', {
        ...
        new s3deploy.BucketDeployment(this, 'DeployWebsite', {
            sources: [s3deploy.Source.asset('./lib/hosting/landing-page')],
