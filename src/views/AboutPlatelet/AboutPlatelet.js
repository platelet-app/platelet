    ...
    return (
        <div className={classes.root}>
            <Grid container direction={"column"} spacing={3} className={classes.inner}>
                ...
                <Grid item>
                    <Typography>
                        Platelet was created in response to an increasing demand on the blood biker network across the
                        UK.
                        Its primary mission is to unify all blood bike charities under one centralised system, helping
                        volunteers deliver a vital service with a modern and easy to use application that works on any
                ...
                <Grid item>
                    ...
                    <Typography>
                        Some of the goals of platelet are to:
                    </Typography>
                </Grid>
                <Grid item>
                    <Typography>
                        - Provide a robust service for recording assignment details, synchronised across all devices
                        <Typography>
                        </Typography>
                        - Let volunteers coordinate cross country relays over a wide network of charities
                        <Typography>
                        </Typography>
                        ...
                        - Allow direct requests for deliveries by hospital staff through a web interface
                        <Typography>
                        </Typography>
