...
export const ON_CHANGE_TASK = "ON_CHANGE_TASK";

export const UPDATE_TASK_TIME_CANCELLED_FROM_SOCKET =
    "UPDATE_TASK_TIME_CANCELLED_FROM_SOCKET";
export const UPDATE_TASK_TIME_REJECTED_FROM_SOCKET =
...
export const START_REFRESH_TASKS_LOOP_FROM_SOCKET =
    "START_REFRESH_TASKS_LOOP_FROM_SOCKET";
export const UPDATE_TASK_PICKUP_LOCATION_FROM_SOCKET =
    "UPDATE_TASK_PICKUP_LOCATION_FROM_SOCKET";
export const UPDATE_TASK_DROPOFF_LOCATION_FROM_SOCKET =
...
export const taskCategoryActionFunctions =
    generateTaskCategoryActionsFunctions(taskCategoryActions);

export const addTaskPrefix = "ADD_TASK";
export const addTaskActions = createRequestActions(addTaskPrefix);
export const { addTaskSuccess, addTaskFailure, addTaskForbidden } =
    createRequestFunctions(addTaskActions);
...
export function addTaskRequest(
    ...
    return {
        type: addTaskActions.request,
        data: {
            payload,
            autoAssign: { role: autoAssignRole, uuid: autoAssignUserUUID },
        },
    };
}
...
export const {
    addTaskRelaySuccess,
    addTaskRelayFailure,
    addTaskRelayForbidden,
} = createRequestFunctions(addTaskRelayActions);

// TODO: does this need a payload parameter?
export function addTaskRelayRequest(
    relayPrevious,
    autoAssignRole = "",
    autoAssignUserUUID = ""
) {
    return {
        type: addTaskRelayActions.request,
        data: {
            relayPrevious,
            autoAssign: { role: autoAssignRole, uuid: autoAssignUserUUID },
        },
...
export const { deleteTaskSuccess, deleteTaskFailure, deleteTaskForbidden } =
    createRequestFunctions(deleteTaskActions);
...
export const { restoreTaskSuccess, restoreTaskFailure, restoreTaskForbidden } =
    createRequestFunctions(restoreTaskActions);
...
export const updateTaskRequesterContactActions = createRequestActions(
    updateTaskRequesterContactPrefix
);
export const {
    updateTaskRequesterContactSuccess,
    updateTaskRequesterContactFailure,
    updateTaskRequesterContactForbidden,
} = createRequestFunctions(updateTaskRequesterContactActions);

export function updateTaskRequesterContactRequest(taskUUID, payload) {
    return {
        type: updateTaskRequesterContactActions.request,
        data: { taskUUID, payload },
    };
}

export const updateTaskPickupTimePrefix = "UPDATE_TASK_PICKUP_TIME";
export const updateTaskPickupTimeActions = createRequestActions(
    updateTaskPickupTimePrefix
);
export const {
    updateTaskPickupTimeSuccess,
    updateTaskPickupTimeFailure,
    updateTaskPickupTimeForbidden,
} = createRequestFunctions(updateTaskPickupTimeActions);

export function updateTaskPickupTimeRequest(taskUUID, payload) {
    return {
        type: updateTaskPickupTimeActions.request,
        data: { taskUUID, payload },
    };
}

export const updateTaskDropoffTimePrefix = "UPDATE_TASK_DROPOFF_TIME";
export const updateTaskDropoffTimeActions = createRequestActions(
    updateTaskDropoffTimePrefix
);
export const {
    updateTaskDropoffTimeSuccess,
    updateTaskDropoffTimeFailure,
    updateTaskDropoffTimeForbidden,
} = createRequestFunctions(updateTaskDropoffTimeActions);

export function updateTaskDropoffTimeRequest(taskUUID, payload) {
    return {
        type: updateTaskDropoffTimeActions.request,
        data: { taskUUID, payload },
    };
}

export const updateTaskCancelledTimePrefix = "UPDATE_TASK_CANCELLED_TIME";
export const updateTaskCancelledTimeActions = createRequestActions(
    updateTaskCancelledTimePrefix
);
export const {
    updateTaskCancelledTimeSuccess,
    updateTaskCancelledTimeFailure,
    updateTaskCancelledTimeForbidden,
} = createRequestFunctions(updateTaskCancelledTimeActions);

export function updateTaskCancelledTimeRequest(taskUUID, payload) {
    return {
        type: updateTaskCancelledTimeActions.request,
        data: { taskUUID, payload },
    };
}

export const updateTaskRejectedTimePrefix = "UPDATE_TASK_REJECTED_TIME";
export const updateTaskRejectedTimeActions = createRequestActions(
    updateTaskRejectedTimePrefix
);
export const {
    updateTaskRejectedTimeSuccess,
    updateTaskRejectedTimeFailure,
    updateTaskRejectedTimeForbidden,
} = createRequestFunctions(updateTaskRejectedTimeActions);

export function updateTaskRejectedTimeRequest(taskUUID, payload) {
    return {
        type: updateTaskRejectedTimeActions.request,
        data: { taskUUID, payload },
    };
}

export const updateTaskPriorityPrefix = "UPDATE_TASK_PRIORITY";
export const updateTaskPriorityActions = createRequestActions(
    updateTaskPriorityPrefix
);
export const {
    updateTaskPrioritySuccess,
    updateTaskPriorityFailure,
    updateTaskPriorityForbidden,
} = createRequestFunctions(updateTaskPriorityActions);

export function updateTaskPriorityRequest(taskUUID, payload) {
    return {
        type: updateTaskPriorityActions.request,
        data: { taskUUID, payload },
    };
}

export const updateTaskPatchPrefix = "UPDATE_TASK_PATCH";
export const updateTaskPatchActions = createRequestActions(
    updateTaskPatchPrefix
);
export const {
    updateTaskPatchSuccess,
    updateTaskPatchFailure,
    updateTaskPatchForbidden,
} = createRequestFunctions(updateTaskPatchActions);

export function updateTaskPatchRequest(taskUUID, payload) {
    return {
        type: updateTaskPatchActions.request,
        data: { taskUUID, payload },
    };
}
...
export const { updateTaskSuccess, updateTaskFailure, updateTaskForbidden } =
    createRequestFunctions(updateTaskActions);
...
export const updateTaskTimeOfCallActions = createRequestActions(
    updateTaskTimeOfCallPrefix
);
export const { updateTaskTimeOfCallFailure, updateTaskTimeOfCallSuccess } =
    createRequestFunctions(updateTaskTimeOfCallActions);

export function updateTaskTimeOfCallRequest(taskUUID, payload) {
    return {
        type: updateTaskTimeOfCallActions.request,
        data: { taskUUID, payload },
    };
}
...
export const {
    ...
    getTasksNotFound,
    getTasksForbidden,
} = createRequestFunctions(getTasksActions);
...
export const { putTaskSuccess, putTaskFailure, putTaskForbidden } =
    createRequestFunctions(putTaskActions);
...
export function setRoleViewAndGetTasks(userUUID, page, role) {
    return {
        type: SET_ROLE_VIEW_AND_GET_TASKS,
        data: { userUUID, page, role },
    };
}
...
export function onChangeTask(taskId, values) {
    return { type: ON_CHANGE_TASK, data: { taskId, values } };
}
