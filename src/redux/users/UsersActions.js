...
export const {getUsersSuccess, getUsersFailure, getUsersForbidden} = createRequestFunctions(getUsersActions);

export function getUsersRequest() {
    return { type: getUsersActions.request }
}
...
export function updateUserRequest(userUUID, payload) {
    return { type: updateUserActions.request, data: {userUUID, payload} }
}
...
export function updateUserPasswordRequest(userUUID, password) {
    return { type: updateUserPasswordActions.request, data: {userUUID, payload: {password}} }
}
